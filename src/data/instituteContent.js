...
const news = [
  ...
  {
    id: 'student-study-week',
    title: L('Студенттердің оқу апталығы', 'Учебная неделя студентов', 'Student study week', 'أسبوع دراسة الطلاب'),
    excerpt: L(
      'Институт студенттері араб тілі, Құран, фиқһ және тәфсір пәндері бойынша апталық оқу қорытындысын таныстырды.',
      'Студенты института представили итоги учебной недели по арабскому языку, Корану, фикху и тафсиру.',
      'Institute students presented the results of a study week in Arabic, Quran, fiqh and tafsir.',
      'عرض طلاب المعهد نتائج أسبوع دراسي في العربية والقرآن والفقه والتفسير.'
    ),
    category: L('Оқу', 'Обучение', 'Learning', 'التعليم'),
    date: '2025',
    image: baseImages.studyGroup,
    content: L(
      '<p>Оқу апталығы барысында студенттер негізгі пәндер бойынша меңгерген тақырыптарын қайталап, ұстаздар алдында қысқа таныстырылым жасады. Мұндай жұмыс білімді бекітуге және жауапты академиялық орта қалыптастыруға бағытталған.</p>',
      '<p>В течение учебной недели студенты повторили ключевые темы по основным предметам и выступили с краткими презентациями перед преподавателями. Такой формат помогает закрепить знания и развивает ответственную академическую среду.</p>',
      '<p>During the study week, students reviewed key topics from core subjects and gave short presentations to faculty. The format helps consolidate knowledge and strengthens a responsible academic culture.</p>',
      '<p>خلال أسبوع الدراسة راجع الطلاب الموضوعات الأساسية وقدموا عروضا موجزة أمام الأساتذة، مما يساعد على ترسيخ المعرفة وبناء بيئة علمية مسؤولة.</p>'
    ),
  },
  {
    id: 'library-update',
    title: L('Кітапхана қоры толықты', 'Библиотечный фонд пополнен', 'Library collection updated', 'تحديث مجموعة المكتبة'),
    excerpt: L(
      'Оқу үдерісіне қажет классикалық еңбектер мен араб тіліне арналған оқу құралдары кітапхана қорына енгізілді.',
      'В библиотеку добавлены классические труды и учебные пособия по арабскому языку, необходимые для учебного процесса.',
      'Classical works and Arabic learning resources needed for the academic process were added to the library.',
      'أضيفت إلى المكتبة متون كلاسيكية ومواد تعليمية للغة العربية يحتاجها المسار الدراسي.'
    ),
    category: L('Кітапхана', 'Библиотека', 'Library', 'المكتبة'),
    date: '2025',
    image: baseImages.about,
    content: L(
      '<p>Кітапхана қоры студенттердің күнделікті сабақта және жеке ізденісте қолданатын негізгі еңбектерімен толықты. Жаңартылған қор араб тілі, Құран ілімдері, фиқһ, хадис және ақида бағыттарын қамтиды.</p>',
      '<p>Библиотечный фонд пополнился основными трудами, которые студенты используют на занятиях и в самостоятельной работе. Обновление охватывает арабский язык, коранические науки, фикх, хадис и акиду.</p>',
      '<p>The library collection was expanded with core works used by students in class and independent study. The update covers Arabic, Quranic sciences, fiqh, hadith and aqidah.</p>',
      '<p>توسعت مجموعة المكتبة بكتب أساسية يستخدمها الطلاب في الدروس والدراسة الفردية، وتشمل العربية وعلوم القرآن والفقه والحديث والعقيدة.</p>'
    ),
  },
];
